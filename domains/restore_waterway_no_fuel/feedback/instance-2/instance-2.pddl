(define (problem deb_sct_shp_sal_ast_1_1_1_c_2_l_3_end_1_problem_2) (:domain restore_waterway_no_fuel)
(:objects
    wpt_ini wpt_end
    wpt_a_0 wpt_a_1 wpt_a_2 
    wpt_b_0 wpt_b_1 wpt_b_2 
    deb_stn_0
    shp_dck_0 - location
    shp_0 - ship 
    ...
    n_deb_ini_a_0 n_deb_a_0_a_1 n_deb_a_1_a_2 n_deb_a_2_end - normal_debris
    u_deb_ini_b_0 u_deb_b_0_b_1 u_deb_b_1_b_2 u_deb_b_2_end - underwater_debris
...
(:init
    ...
    (is_location_connected wpt_a_0 wpt_a_1)
    (is_location_connected wpt_a_1 wpt_a_0)
    (is_location_connected wpt_a_1 wpt_a_2)
    (is_location_connected wpt_a_2 wpt_a_1)
    (is_location_connected wpt_a_2 wpt_end)
    (is_location_connected wpt_end wpt_a_2)
    (is_location_connected wpt_ini wpt_b_0)
    (is_location_connected wpt_b_0 wpt_ini)
    (is_location_connected wpt_b_0 wpt_b_1)
    (is_location_connected wpt_b_1 wpt_b_0)
    (is_location_connected wpt_b_1 wpt_b_2)
    (is_location_connected wpt_b_2 wpt_b_1)
    (is_location_connected wpt_b_2 wpt_end)
    (is_location_connected wpt_end wpt_b_2)
    ...
    (= (connected_location_distance wpt_a_0 wpt_a_1) 10)
    (= (connected_location_distance wpt_a_1 wpt_a_0) 10)
    (= (connected_location_distance wpt_a_1 wpt_a_2) 10)
    (= (connected_location_distance wpt_a_2 wpt_a_1) 10)
    (= (connected_location_distance wpt_a_2 wpt_end) 10)
    (= (connected_location_distance wpt_end wpt_a_2) 10)
    (= (connected_location_distance wpt_ini wpt_b_0) 10)
    (= (connected_location_distance wpt_b_0 wpt_ini) 10)
    (= (connected_location_distance wpt_b_0 wpt_b_1) 10)
    (= (connected_location_distance wpt_b_1 wpt_b_0) 10)
    (= (connected_location_distance wpt_b_1 wpt_b_2) 10)
    (= (connected_location_distance wpt_b_2 wpt_b_1) 10)
    (= (connected_location_distance wpt_b_2 wpt_end) 10)
    (= (connected_location_distance wpt_end wpt_b_2) 10)
    ...
    (at n_deb_a_0_a_1 wpt_a_0)
    (at n_deb_a_0_a_1 wpt_a_1)
    (at n_deb_a_1_a_2 wpt_a_1)
    (at n_deb_a_1_a_2 wpt_a_2)
    (at n_deb_a_2_end wpt_a_2)
    (at n_deb_a_2_end wpt_end)
    ;underwater debris location (at)
    (at u_deb_ini_b_0 wpt_ini)
    (at u_deb_ini_b_0 wpt_b_0)
    (at u_deb_b_0_b_1 wpt_b_0)
    (at u_deb_b_0_b_1 wpt_b_1)
    (at u_deb_b_1_b_2 wpt_b_1)
    (at u_deb_b_1_b_2 wpt_b_2)
    (at u_deb_b_2_end wpt_b_2)
    (at u_deb_b_2_end wpt_end)
    ;normal debris weight [kg] (debris_weight)
    (= (debris_weight n_deb_ini_a_0) 200)
    (= (debris_weight n_deb_a_0_a_1) 200)
    (= (debris_weight n_deb_a_1_a_2) 200)
    (= (debris_weight n_deb_a_2_end) 200)
    ;underwater debris weight [kg] (debris_weight)
    (= (debris_weight u_deb_ini_b_0) 200)
    (= (debris_weight u_deb_b_0_b_1) 200)
    (= (debris_weight u_deb_b_1_b_2) 200)
    (= (debris_weight u_deb_b_2_end) 200)

    ;define authority predicates / functions
    ;authority over (has_authority_over_location)
    (has_authority_over_location aut_a wpt_a_0)
    (has_authority_over_location aut_a wpt_a_1)
    (has_authority_over_location aut_a wpt_a_2)
    (has_authority_over_location aut_b wpt_b_0)
    (has_authority_over_location aut_b wpt_b_1)
    (has_authority_over_location aut_b wpt_b_2)
    ;reply time [h]
...
(:goal (and
    (is_location_not_blocked wpt_a_2 wpt_end)
    (is_location_not_blocked wpt_end wpt_a_2)
    (is_location_not_blocked wpt_b_2 wpt_end)
    (is_location_not_blocked wpt_end wpt_b_2)
    (at shp_0 shp_dck_0)
    (at deb_ast_0 wpt_ini)
    (at sct_ast_0 wpt_ini)
    (at shp_sal_ast_0 wpt_ini)
