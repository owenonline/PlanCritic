(define (problem deb_sct_shp_sal_ast_1_1_1_c_2_l_1_end_1_problem_2) (:domain restore_waterway_no_fuel)
(:objects
    wpt_ini wpt_end
    wpt_a_0 wpt_b_0
    deb_stn_0
...
(:goal (and
    (is_location_not_blocked wpt_a_0 wpt_end)
    (is_location_not_blocked wpt_end wpt_a_0)
    (at shp_0 shp_dck_0)
    (at deb_ast_0 wpt_ini)
    (at sct_ast_0 wpt_ini)
    (at shp_sal_ast_0 wpt_ini)
