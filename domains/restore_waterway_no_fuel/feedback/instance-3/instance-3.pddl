(define (problem deb_sct_shp_sal_ast_1_1_1_c_2_l_3_end_1_problem_1) (:domain restore_waterway_no_fuel)
(:objects
    wpt_ini wpt_end
...
(:init
    ...
    (= (debris_weight n_deb_a_0_a_1) 100)
    (= (debris_weight n_deb_a_1_a_2) 100)
    (= (debris_weight n_deb_a_2_end) 100)
    ;underwater debris weight [kg] (debris_weight)
    (= (debris_weight u_deb_ini_b_0) 100)
    (= (debris_weight u_deb_b_0_b_1) 100)
    (= (debris_weight u_deb_b_1_b_2) 100)
    (= (debris_weight u_deb_b_2_end) 100)
